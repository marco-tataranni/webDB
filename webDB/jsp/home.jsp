...
<html>
    ...
    <%
        ...
        if(request.getMethod().equals("GET"))
        {
            ...
            if (cka.length>0)
            {
                if(cka[0].getName().equals("user"))
                {
                   output="benvenuto nella home "+cka[0].getValue(); 
                }
            }else
            {
              %>
            ...
            try { // Load SQL Server JDBC driver and establish connection.
              ...
              if(output.isEmpty()){
    	        ...
    	        if(output.isEmpty()){
    			   ...
    			   st2.executeUpdate();
    	           output="Registrato con successo!";  
    	        }
                 ...
                 if(output.isEmpty()){
    	             ...
    	             if(rs4.next()){
    	               ...
    	               Cookie ck=new Cookie("user", request.getParameter("LoginUser"));
